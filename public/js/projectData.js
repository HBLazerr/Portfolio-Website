export const projectData = {
  ...
  section2: {
    ...
    screenshots: ["../media/lazerrs-player.png", "../media/lazerrs-player-screenshot1.png", "../media/lazerrs-player-screenshot2.png", "../media/lazerrs-player-screenshot3.png"],
    role: "Solo Developer",
  ...
  section3: {
    ...
    screenshots: ["../media/WeatherDAN.png", "../media/WeatherDAN-screenshot1.png", "../media/WeatherDAN-screenshot2.png"],
  ...
  section5: {
    ...
    gradient: "linear-gradient(160deg, rgb(28, 85, 23) 0%, rgb(12, 12, 12) 50%, rgb(2, 12, 1) 100%)",
  ...
  section7: {
    ...
    screenshots: ["../media/MovieLSTER.png", "../media/MovieLSTER-screenshot1.png", "../media/MovieLSTER-screenshot2.png", "../media/MovieLSTER-screenshot3.png"],
    role: "Solo Developer",
  ...
  section8: {
    ...
    duration: "10 HRS",
    year: "2023",
    description: "A console-based maze generator that uses recursive backtracking to carve randomized ASCII mazes from a 2D grid. Built from scratch with user input, dynamic sizing, and visual output.",
    url: "https://youtu.be/6bjArLnZPew?si=mN8E4bLWiFQ8jSlc",
    image: "../media/ascii-maze-gif.gif",
    screenshots: ["../media/ascii-maze-screenshot1.png", "../media/ascii-maze-screenshot2.png", "../media/ascii-maze-screenshot3.png", "../media/ascii-maze-screenshot4.png"],
    role: "Solo Developer",
  ...
  section9: {
    ...
    duration: "14 HRS",
    year: "2024",
    description: "Explored Pokémon dataset to analyze stats like speed, type, and abilities. Built a hash map to group and search Pokémon by type, and implemented custom sorting to rank stats. Applied data structure techniques to efficiently identify patterns that predict legendary status.",
    ...
    screenshots: ["../media/pokemon-data-screenshot1.png", "../media/pokemon-data-screenshot2.png", "../media/pokemon-data-screenshot3.png", "../media/pokemon-data-screenshot4.png", "../media/pokemon-data-screenshot5.png", "../media/pokemon-data-screenshot6.png", "../media/pokemon-data-screenshot7.png"],
    role: "Data Analyst",
